...
model_name        = 'Ocl_senet50_Rec_adam_norm_space_channel_celeba'
...
loss_weight = [1, 1, 1, 0, 0, 5] # non, cos, ocl, spacess, channelss
# ------------- fine tune weight -----------
...
os.system('python train_celeba.py {}'.format(" ".join(param)))
