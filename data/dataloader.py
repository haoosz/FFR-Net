...
def create_dataloader(opts,  test_ocl_num=0):
    ...
    if is_train:
        if opts.train_data == '../data_occlusion/CASIA-Warp':
            ...
            data = dataset.CASIA(opts.train_data, img_list, ocl_list, opts.pair_same, shuffle, tf_train)
        ...
        data = dataset.LFWData(face_root, ocl_root, ocl_list, transform=tf_test)
